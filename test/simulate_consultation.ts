...
engine.processUtterance('Patient reports severe headache and dizziness for the past 4 days.', 'Patient');
...
engine.processUtterance('Physical exam: blood pressure is 158/96 mmHg, pulse is 88 bpm.', 'Doctor');
...
engine.processUtterance('My assessment is essential hypertension stage two.', 'Doctor');
...
engine.processUtterance('Let us prescribe Lisinopril 10mg daily and schedule follow-up in 2 weeks.', 'Doctor');
...
engine.processUtterance('Patient took Ibuprofen 800mg yesterday for knee pain.', 'Patient');
...
const markdownReport = engine.exportMarkdown({ patientName: 'Jane Doe', physicianName: 'Dr. Sarah Jenkins' });
